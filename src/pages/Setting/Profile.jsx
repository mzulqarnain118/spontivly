...
const Profile = () => {
    ...
    const panels = [
        { key: 'profile', title: 'Profile', subheader: 'This information will be displayed publicly.', component: <ProfileContent /> },
        { key: 'bio', title: 'Bio', subheader: 'Add additional details for your profile.' },
        { key: 'social', title: 'Social Integerations', subheader: 'Your social media profiles.' },
        { key: 'password', title: 'Update Password', subheader: 'By changing your password, you help make sure that only you can use your account.' },
    ];
